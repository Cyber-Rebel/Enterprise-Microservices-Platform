...
const Dashboard = () => {
  ...
  const { metrics, recentOrders, isLoading } = useSelector((state) => state.dashboard);
  ...
  const statsCards = [
    {
      ...
      value: products?.length || metrics.totalProducts || 0,
      icon: (
  ...
  return (
    <div className="space-y-8">
      {/* Welcome Section */}
      <div className="bg-gradient-to-r from-orange-500 to-amber-500 rounded-3xl p-6 md:p-8 text-white shadow-xl">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <Link
            to="/products/add"
            className="mt-4 md:mt-0 inline-flex items-center px-6 py-3 bg-white text-orange-600 font-semibold rounded-xl hover:bg-orange-50 transition-colors shadow-lg"
          >
          ...
          <div className="p-6">
            {isLoading ? (
              ...
              <div className="text-center py-8">
                ...
                <Link
                  to="/products/add"
                  className="mt-4 inline-flex items-center text-orange-600 font-medium hover:text-orange-700"
                >
                ...
                {recentOrders.map((order) => (
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div className="w-10 h-10 bg-gradient-to-r from-orange-500 to-amber-500 rounded-xl flex items-center justify-center text-white font-semibold">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="flex flex-col items-center p-4 rounded-xl bg-purple-50 hover:bg-purple-100 transition-colors cursor-pointer">
